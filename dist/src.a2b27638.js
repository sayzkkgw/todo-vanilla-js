...
var onClickAdd = function onClickAdd() {
  ...
  document.getElementById("add-text").value = ""; // alert(inputText);
};

var deleteFromIncompletedList = function deleteFromIncompletedList(target) {
  document.getElementById("incompleted-list").removeChild(target);
};

var deleteFromCompletedList = function deleteFromCompletedList(target) {
...
var createIncompleteList = function createIncompleteList(text) {
  ...
  div.className = "list-row"; // Generate li tag

  var li = document.createElement("li");
  li.innerText = text;
  document.getElementById("incompleted-list").appendChild(div); // Complete button

  var completedButton = document.createElement("button");
  completedButton.innerText = "Complete";
  completedButton.addEventListener("click", function () {
    // Element to add as complete
    var completeTarget = completedButton.parentNode; // Remove from incomplete

    deleteFromIncompletedList(completeTarget); // Todo text

    var text = completeTarget.firstElementChild.innerText; // Clean contetn under div

    completeTarget.textContent = null; // Add Todo text in completed line

    var li = document.createElement("li");
    li.innerText = text; // Add revert button

    var revertButton = document.createElement("button");
    revertButton.innerText = "Revert";
    revertButton.addEventListener("click", function () {
      var deleteTarget = revertButton.parentNode;
      deleteFromCompletedList(deleteTarget);
      var text = revertButton.parentNode.firstElementChild.innerText;
